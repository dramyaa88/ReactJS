          ...
          <div class="flex m-2   px-20 pt-10">
            <div class="relative hidden md:block">
              ...
              <input
                type="text"
                id="search-navbar"
                class=" w-full p-2 m-2 pl-10 text-sm text-gray-900 border  rounded-lg bg-gray-50 dark:bg-gray-700   "
                placeholder="Search..."
                value={searchText}
                onChange={(e) => {
            ...
            <button
              class="p-2 m-2  bg-purple-500 hover:bg-purple-900 text-white rounded-md"
              onClick={() => {
