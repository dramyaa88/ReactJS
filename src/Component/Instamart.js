    ...
    return (
        <div>
            <div class="font-bold  tracking-wide px-36 ">
                <h1 class="text-3xl pt-6 pb-4">Instamart</h1>
        </div>
        <div class="pt-10 pb-28 text-[18px] tracking-wide font-[100] px-36">
            ...
            setIsVisible ={() => setIsVisibleSection((isVisibleSection == "team")? "" : "team")}
            />
            ...
            setIsVisible ={() => setIsVisibleSection((isVisibleSection == "career")? "" : "career")}
            />
        </div>
        </div>
    )
